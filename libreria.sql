...
FOREIGN KEY (cliente_cf) REFERENCES cliente(CF) ON DELETE CASCADE,
...
PRIMARY KEY(id),
FOREIGN KEY (cliente_cf) REFERENCES cliente(CF) ON DELETE CASCADE,
FOREIGN KEY (lib_S) REFERENCES libro(SSN) ON DELETE CASCADE
);
...
FOREIGN KEY (imp_cod) REFERENCES impiegato(codiceI) ON DELETE CASCADE,
FOREIGN KEY (lib_S) REFERENCES libro(SSN) ON DELETE CASCADE
);